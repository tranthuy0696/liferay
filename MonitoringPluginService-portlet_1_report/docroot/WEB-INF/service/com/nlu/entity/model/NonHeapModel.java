...
/**
 * The base model interface for the NonHeap service. Represents a row in the &quot;NonHeap&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.nlu.entity.model.impl.NonHeapModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.nlu.entity.model.impl.NonHeapImpl}.
 * </p>
 *
 * @author NgocBao
 * @see NonHeap
 ...
 * @generated
 */
public interface NonHeapModel extends BaseModel<NonHeap> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a non heap model instance should use the {@link NonHeap} interface instead.
	 */
	...
	@Override
	public CacheModel<com.nlu.entity.model.NonHeap> toCacheModel();
