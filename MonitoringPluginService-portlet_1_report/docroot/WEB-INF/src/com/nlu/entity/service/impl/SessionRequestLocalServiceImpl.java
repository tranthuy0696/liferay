...
//	public List<SessionRequest> searchSessionRequestByDate(String date) throws SystemException{
//		DynamicQuery dq=DynamicQueryFactoryUtil.forClass(SessionRequest.class, "sessionRequest", PortletClassLoaderUtil.getClassLoader());
//		String value = (new StringBuilder("%")).append(date).append("%").toString();
//        dq.add(RestrictionsFactoryUtil.like("sessionRequest.time", value));
//        List<SessionRequest> result=SessionRequestLocalServiceUtil.dynamicQuery(dq);
//        return result;
//	}
	public List<SessionRequest> searchSessionRequestByDate(String date){
		return sessionRequestFinder.searchSessionRequestByDate(date);
	}
	public List getSessionReportByDate(String name, String date){
		 return sessionRequestFinder.getListSessionRequestReportByDate(name, date);
	}
}