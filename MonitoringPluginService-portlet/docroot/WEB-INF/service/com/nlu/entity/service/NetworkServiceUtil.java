...
/**
 * Provides the remote service utility for Network. This utility wraps
 * {@link com.nlu.entity.service.impl.NetworkServiceImpl} and is the
 ...
 * @see com.nlu.entity.service.impl.NetworkServiceImpl
 * @generated
 */
public class NetworkServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.nlu.entity.service.impl.NetworkServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static NetworkService getService() {
		if (_service == null) {
			...
			if (invokableService instanceof NetworkService) {
				_service = (NetworkService)invokableService;
			}
			else {
				_service = new NetworkServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(NetworkServiceUtil.class,
				"_service");
		}
