 ...
 * @generated
 */
public class diachiLocalServiceClp implements diachiLocalService {
	public diachiLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public com.nlu.entity.model.diachi adddiachi(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(diachi) });
		}
		catch (Throwable t) {
		...
		return (com.nlu.entity.model.diachi)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.nlu.entity.model.diachi> getdiachis(int start,
		...
		return (java.util.List<com.nlu.entity.model.diachi>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public com.nlu.entity.model.diachi adddiachi(long userId, long id,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(duong),
						
					ClpSerializer.translateInput(duongKhac),
						
					ClpSerializer.translateInput(khuPho),
						
					ClpSerializer.translateInput(soNha),
