...
/**
 * The persistence utility for the network service. This utility wraps {@link NetworkPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class NetworkUtil {
	 ...
	 */
	public static void clearCache(Network network) {
		getPersistence().clearCache(network);
	}
	 ...
	 */
	public static List<Network> findWithDynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
	 ...
	 */
	public static List<Network> findWithDynamicQuery(
	 ...
	 */
	public static Network update(Network network) throws SystemException {
	 ...
	 */
	public static Network update(Network network, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(network, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.nlu.entity.model.Network network) {
	...
	*/
	public static com.nlu.entity.model.Network create(long networkId) {
	...
	*/
	public static com.nlu.entity.model.Network remove(long networkId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.nlu.entity.NoSuchNetworkException {
		return getPersistence().remove(networkId);
	}

	public static com.nlu.entity.model.Network updateImpl(
		com.nlu.entity.model.Network network)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(network);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.Network findByPrimaryKey(long networkId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.nlu.entity.NoSuchNetworkException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.Network fetchByPrimaryKey(long networkId)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static NetworkPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (NetworkPersistence)PortletBeanLocatorUtil.locate(com.nlu.entity.service.ClpSerializer.getServletContextName(),
					NetworkPersistence.class.getName());

			ReferenceRegistry.registerReference(NetworkUtil.class,
				"_persistence");
		}
