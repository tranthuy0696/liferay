...
/**
 * Provides the remote service interface for diachi. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author NgocBao
 * @see diachiServiceUtil
...
public interface diachiService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link diachiServiceUtil} to access the diachi remote service. Add custom service methods to {@link com.nlu.entity.service.impl.diachiServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
