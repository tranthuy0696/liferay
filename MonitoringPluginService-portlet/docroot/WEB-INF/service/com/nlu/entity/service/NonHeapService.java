...
/**
 * Provides the remote service interface for NonHeap. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author NgocBao
 * @see NonHeapServiceUtil
...
public interface NonHeapService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NonHeapServiceUtil} to access the non heap remote service. Add custom service methods to {@link com.nlu.entity.service.impl.NonHeapServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
