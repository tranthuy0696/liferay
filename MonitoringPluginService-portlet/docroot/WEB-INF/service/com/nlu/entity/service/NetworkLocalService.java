...
/**
 * Provides the local service interface for Network. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NgocBao
 * @see NetworkLocalServiceUtil
...
public interface NetworkLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NetworkLocalServiceUtil} to access the network local service. Add custom service methods to {@link com.nlu.entity.service.impl.NetworkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
