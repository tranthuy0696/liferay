...
import com.nlu.entity.service.HeapLocalService;
...
/**
 * Provides the base implementation for the heap local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.nlu.entity.service.impl.HeapLocalServiceImpl}.
 * </p>
 *
 * @author NgocBao
 ...
 * @generated
 */
public abstract class HeapLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements HeapLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.nlu.entity.service.HeapLocalServiceUtil} to access the heap local service.
	 */
	...
	@Override
	public Heap addHeap(Heap heap) throws SystemException {
		heap.setNew(true);

		return heapPersistence.update(heap);
	}
	 ...
	 */
	@Override
	public Heap createHeap(long heapId) {
		return heapPersistence.create(heapId);
	}
	...
	@Override
	public Heap deleteHeap(long heapId) throws PortalException, SystemException {
		return heapPersistence.remove(heapId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Heap deleteHeap(Heap heap) throws SystemException {
		return heapPersistence.remove(heap);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Heap.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return heapPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return heapPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return heapPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return heapPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Heap fetchHeap(long heapId) throws SystemException {
		return heapPersistence.fetchByPrimaryKey(heapId);
	}
	...
	public Heap getHeap(long heapId) throws PortalException, SystemException {
		return heapPersistence.findByPrimaryKey(heapId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return heapPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Heap> getHeaps(int start, int end) throws SystemException {
		return heapPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getHeapsCount() throws SystemException {
		return heapPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Heap updateHeap(Heap heap) throws SystemException {
		return heapPersistence.update(heap);
	}
	...
	public void afterPropertiesSet() {
		...
		com.nlu.entity.service.HeapLocalServiceUtil.clearService();

		PersistedModelLocalServiceRegistryUtil.register("com.nlu.entity.model.Heap",
			heapLocalService);
	}
	...
	private HeapLocalServiceClpInvoker _clpInvoker = new HeapLocalServiceClpInvoker();
}