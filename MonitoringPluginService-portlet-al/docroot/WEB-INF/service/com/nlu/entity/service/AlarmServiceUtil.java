...
/**
 * Provides the remote service utility for Alarm. This utility wraps
 * {@link com.nlu.entity.service.impl.AlarmServiceImpl} and is the
 ...
 * @see com.nlu.entity.service.impl.AlarmServiceImpl
 * @generated
 */
public class AlarmServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.nlu.entity.service.impl.AlarmServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	...
	public static void deleteAlarm(long alarmId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteAlarm(alarmId);
	}
	...
	public static AlarmService getService() {
		if (_service == null) {
			...
			if (invokableService instanceof AlarmService) {
				_service = (AlarmService)invokableService;
			}
			else {
				_service = new AlarmServiceClp(invokableService);
			}

			ReferenceRegistry.registerReference(AlarmServiceUtil.class,
				"_service");
		}
	...
	private static AlarmService _service;
}