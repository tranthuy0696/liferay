...
/**
 * The persistence utility for the alarm info service. This utility wraps {@link AlarmInfoPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class AlarmInfoUtil {
	 ...
	 */
	public static void clearCache(AlarmInfo alarmInfo) {
		getPersistence().clearCache(alarmInfo);
	}
	 ...
	 */
	public static List<AlarmInfo> findWithDynamicQuery(
	 ...
	 */
	public static AlarmInfo update(AlarmInfo alarmInfo)
		throws SystemException {
		return getPersistence().update(alarmInfo);
	}
	...
	public static AlarmInfo update(AlarmInfo alarmInfo,
		...
		return getPersistence().update(alarmInfo, serviceContext);
	}
	...
	*/
	public static java.util.List<com.nlu.entity.model.AlarmInfo> findByname(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo findByname_First(
		java.lang.String name,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo fetchByname_First(
		java.lang.String name,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo findByname_Last(
		java.lang.String name,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.nlu.entity.NoSuchAlarmInfoException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo fetchByname_Last(
		java.lang.String name,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo[] findByname_PrevAndNext(
		long alarmInfoId, java.lang.String name,
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.nlu.entity.NoSuchAlarmInfoException {
		return getPersistence()
				   .findByname_PrevAndNext(alarmInfoId, name, orderByComparator);
	}
	...
	*/
	public static void cacheResult(com.nlu.entity.model.AlarmInfo alarmInfo) {
		getPersistence().cacheResult(alarmInfo);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(alarmInfos);
	}
	...
	*/
	public static com.nlu.entity.model.AlarmInfo create(long alarmInfoId) {
		return getPersistence().create(alarmInfoId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo remove(long alarmInfoId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.nlu.entity.NoSuchAlarmInfoException {
		return getPersistence().remove(alarmInfoId);
	}

	public static com.nlu.entity.model.AlarmInfo updateImpl(
		com.nlu.entity.model.AlarmInfo alarmInfo)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(alarmInfo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo findByPrimaryKey(
		long alarmInfoId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.nlu.entity.NoSuchAlarmInfoException {
		return getPersistence().findByPrimaryKey(alarmInfoId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.nlu.entity.model.AlarmInfo fetchByPrimaryKey(
		long alarmInfoId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(alarmInfoId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.nlu.entity.model.AlarmInfo> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static AlarmInfoPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (AlarmInfoPersistence)PortletBeanLocatorUtil.locate(com.nlu.entity.service.ClpSerializer.getServletContextName(),
					AlarmInfoPersistence.class.getName());

			ReferenceRegistry.registerReference(AlarmInfoUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(AlarmInfoPersistence persistence) {
	}

	private static AlarmInfoPersistence _persistence;
}