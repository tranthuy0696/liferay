...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	@Override
	public int compareTo(com.monitor.portlet.entity.model.Foo foo) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.monitor.portlet.entity.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	@Override
	public com.monitor.portlet.entity.model.Foo toEscapedModel() {
		return new FooWrapper(_foo.toEscapedModel());
	}

	@Override
	public com.monitor.portlet.entity.model.Foo toUnescapedModel() {
