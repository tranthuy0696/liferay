...
<ul>
   <li><a href="${memoryURL}">MEMORY</a></li>
    ...
    <li><a href="${directoryURL}">THƯ MỤC</a></li>
     ...
     <li><a href="<portlet:renderURL><portlet:param name="time" value="1532069883768"/><portlet:param name="nameAlarm" value="cpu"/><portlet:param name="mvcPath" value="/html/systemresource/AlarmDetail.jsp"/></portlet:renderURL>">Alarm</a></li>
</ul>
  </div>
