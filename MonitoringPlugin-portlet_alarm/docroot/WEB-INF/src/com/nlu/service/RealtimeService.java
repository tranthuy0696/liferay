...
public class RealtimeService {
	...
	public NetworkData getNetworkRealtime() throws SigarException {
		NetworkData networkData=NetworkUtil.getMetric();
		networkData.setRx((long)SystemUtil.convertByteToKB(networkData.getRx()));
		networkData.setTx((long)SystemUtil.convertByteToKB(networkData.getTx()));
		return networkData;
	}
}
