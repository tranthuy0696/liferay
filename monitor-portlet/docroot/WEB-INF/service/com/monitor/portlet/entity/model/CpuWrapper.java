...
public class CpuWrapper implements Cpu, ModelWrapper<Cpu> {
	...
	*/
	...
	@Override
	public int compareTo(com.monitor.portlet.entity.model.Cpu cpu) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.monitor.portlet.entity.model.Cpu> toCacheModel() {
		return _cpu.toCacheModel();
	}

	@Override
	public com.monitor.portlet.entity.model.Cpu toEscapedModel() {
		return new CpuWrapper(_cpu.toEscapedModel());
	}

	@Override
	public com.monitor.portlet.entity.model.Cpu toUnescapedModel() {
