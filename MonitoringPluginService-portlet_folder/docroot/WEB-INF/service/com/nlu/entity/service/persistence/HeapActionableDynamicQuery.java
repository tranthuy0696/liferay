 ...
 * @generated
 */
public abstract class HeapActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public HeapActionableDynamicQuery() throws SystemException {
		setBaseLocalService(HeapLocalServiceUtil.getService());
		setClass(Heap.class);

		setClassLoader(com.nlu.entity.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("heapId");
	}
}