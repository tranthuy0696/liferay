...
%>
<portlet:resourceURL id="nonheap" var="memoryAjax"></portlet:resourceURL>
<portlet:resourceURL id="nonheapReport" var="nonheapReport"></portlet:resourceURL>
<!-- <div class="container"> -->
		<!-- 	menu -->
					...
					on : {
						success : function(A, id, obj) {
							memory = JSON.parse(obj.responseText);
							   ...
							   $('#memoryUsage').html('Non-Heap Usage: '+ memory.percentUsage +'% ('+memory.dataUsage+' MB)');
						...
						success : function(A, id, obj) {
							...
							var chart = AmCharts.makeChart("chartdiv", {
							  ...
							  //    "dataDateFormat": 'YYYY-MM-DD JJ:NN:SS',
							    ...
							    "id": "v1",
							    "minimum": 0,
							    "maximum": <%=maxNonHeapMB%>,
							    "title":"NonHeap usage (MB)"
							 }],
							    "export": {
							        "enabled": true
							    }
