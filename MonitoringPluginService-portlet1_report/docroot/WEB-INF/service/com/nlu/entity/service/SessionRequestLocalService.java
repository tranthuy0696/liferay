...
/**
 * Provides the local service interface for SessionRequest. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NgocBao
 * @see SessionRequestLocalServiceUtil
...
public interface SessionRequestLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SessionRequestLocalServiceUtil} to access the session request local service. Add custom service methods to {@link com.nlu.entity.service.impl.SessionRequestLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
