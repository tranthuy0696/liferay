...
public class NetworkLocalServiceClp implements NetworkLocalService {
	public NetworkLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName22 = "deleteNetworkByDate";
	...
	public com.nlu.entity.model.Network addNetwork(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(network) });
		}
		catch (Throwable t) {
		...
		return (com.nlu.entity.model.Network)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<com.nlu.entity.model.Network> getNetworks(int start,
		...
		return (java.util.List<com.nlu.entity.model.Network>)ClpSerializer.translateOutput(returnObj);
	}
